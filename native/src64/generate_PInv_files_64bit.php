...
// this script will generate the PInvoke typedef and casecode files as 64bit versions: 
// *) the parameter and return types are int32, int64, fp32 and fp64:
//	=> int32 = U32 (char-code u)
//	=> int64 = U64 (char-code x)
//	=> fp32 = float (char-code f)
//	=> fp64 = double (char-code d)

$returnTypes = array( "int32", "int64", "fp32", "fp64" );
$paramTypes = array( "int32", "int64", "fp32", "fp64" );
